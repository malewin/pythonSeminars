...
# надо разбить сумму на все возможные уникальные составляющие через цикл пока не вылетит (в каждой иттерации отнимать от суммы единицу), 
...
# result = slagaemye.intersection(mnozhiteli)
