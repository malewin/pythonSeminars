# Archive node - архивные ноды хранят блоки от начала до сегодняшнего дня     (на момент март 2023 года архивные лайтсервера : 2 и 11, полуархивные(около года) - 9, 10)
